...
public class FragmentSignUpBindingImpl extends FragmentSignUpBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.signUpBtnBack, 1);
        ...
        sViewsWithIds.put(R.id.alreadyHaveAccount, 6);
        sViewsWithIds.put(R.id.btnLogin, 7);
        sViewsWithIds.put(R.id.edt_name, 8);
        sViewsWithIds.put(R.id.edt_email, 9);
        sViewsWithIds.put(R.id.edt_password, 10);
        sViewsWithIds.put(R.id.edt_confirm_password, 11);
        sViewsWithIds.put(R.id.btnCreateAccount, 12);
    }
    // views
    // variables
    // values
